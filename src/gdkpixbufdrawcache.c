...
/**
 * SECTION:gdkpixbufdrawcache
 * @short_description: Cache for drawing scaled pixbufs
 *
 * <para>
 *   The main object in this file is #GdkPixbufDrawCache which
 *   provides a cache that should be used by #GtkIImageTool instances
 *   when redrawing the #GtkImageView.
 * </para>
 **/
 ...
 **/
GdkPixbufDrawMethod
gdk_pixbuf_draw_cache_get_method (GdkPixbufDrawOpts *old,
                                  GdkPixbufDrawOpts *new_)
{
    if (new_->zoom != old->zoom ||
        ...
        return GDK_PIXBUF_DRAW_METHOD_SCALE;

    if (gdk_rectangle_contains_rect (old->zoom_rect, new_->zoom_rect))
        return GDK_PIXBUF_DRAW_METHOD_CONTAINS;

    return GDK_PIXBUF_DRAW_METHOD_SCROLL;
}
 ...
 **/
void
gdk_pixbuf_draw_cache_free (GdkPixbufDrawCache *cache)
{
 ...
 **/
void
gdk_pixbuf_draw_cache_invalidate (GdkPixbufDrawCache *cache)
{
...
static GdkPixbuf *
gdk_pixbuf_draw_cache_scroll_intersection (GdkPixbuf    *pixbuf,
                                           int           new_width,
                                           int           new_height,
                                           int           src_x,
                                           int           src_y,
...
/**
 * gdk_pixbuf_draw_cache_intersect_draw:
 *
 ...
 **/
static void
gdk_pixbuf_draw_cache_intersect_draw (GdkPixbufDrawCache *cache,
                                      ...
                                      GdkDrawable        *drawable)
{
    ...
    cache->last_pixbuf =
        gdk_pixbuf_draw_cache_scroll_intersection (cache->last_pixbuf,
                                                   this.width,
                                                   this.height,
                                                   inter.x - old_rect.x,
                                                   inter.y - old_rect.y,
